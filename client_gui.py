...
class TicTacToeClient:
    ...
    def __init__(self, master):
        ...
        self.current_player = PLAYER_CHAR  # Global sabitten alır (X veya O)
        self.opponent_char = OPPONENT_CHAR # Global sabitten alır (O veya X)
        master.title(f"XOX Oyuncusu - {self.current_player}") # Pencere başlığını ayarla
    ...
    def end_game(self,result):
        ...
        if result=="Berabere":
            ...
            messagebox.showinfo("OYUN BİTTİ",message)
